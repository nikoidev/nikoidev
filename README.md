...
### Desarrollador Full-Stack (Python & Next.js) | Arquitectura de Software & IA
...
#### 📥 Importador idempotente CSV/JSON → ERP
...
#### 🧩 Plantilla *starter* de integración con el ERP
Base reutilizable (conexión, maestros, riesgo de crédito y exportación de documentos) para desarrollar rápido nuevos inyectores de datos sobre el ERP.

`FastAPI` `SQLAlchemy` `Alembic` `React` `TypeScript`

---

### 🏢 Divain Team — *Programador Full-Stack Junior* · `2025`

Desarrollo **full-stack** de aplicaciones web: interfaces con **React/Next.js**, **APIs y lógica de negocio en Python**, **modelado y consultas de base de datos** y **mantenimiento y corrección de errores** de la aplicación en producción.

`Python` `React` `Next.js` `TypeScript` `PostgreSQL`

---

### 🏢 Nexeus Big Data Campus — *Desarrollo en equipo*

Experiencia trabajando **en equipo** en proyectos de **datos y plataformas empresariales**, aplicando buenas prácticas de desarrollo y metodologías ágiles (SCRUM).
...
<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=nikoidev&theme=tokyo-night&hide_border=true&bg_color=0d1117&color=58a6ff&line=58a6ff&point=c9d1d9&area=true" alt="Gráfico de contribuciones" />
</p>
